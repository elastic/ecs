...
type Dns struct {
	...
	// "www". If the qualification level cannot be determined hostname need not
	// be filled out.
	...
	// simply taking the last two labels will not work well for TLDs which
	// include country and/or region codes () such as "co.uk".
	...
	// For example, the top level domain for "www.east.mydomain.co.uk" is
	// "mydomain.co.uk"
	// This value can be determined precisely with a list like the public
	// suffix list (http://publicsuffix.org). Trying to approximate this by

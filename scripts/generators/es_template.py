...
def generate_template_version(elasticsearch_version, mappings_section, out_dir):
    ecs_helpers.make_dirs(os.path.join(out_dir, 'elasticsearch', str(elasticsearch_version)))
    ...
    filename = os.path.join(out_dir, "elasticsearch/{}/template.json".format(elasticsearch_version))

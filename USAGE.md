...
- [Usage](#usage)
  ...
  * [Generator Options](#generator-options)
    ...
    + [Elasticsearch Index Mappings JSON Schema](#elasticsearch-index-mappings-json-schema)
...
#### Elasticsearch Index Mappings JSON Schema

Using the `--es-mappings-json-schema` argument generates a [JSON Schema](https://json-schema.org/) to validate Elasticsearch index mappings against ECS. The schema file will be written to `<output_directory>/json_schema/schema.json`. This artifact is not generated by default and will only be created when the `--es-mappings-json-schema` is used.

...
| <<ecs-authenticode,Authenticode>> | TODO
...
| <<ecs-histogram,Histogram>> | These fields contain information about a histogram.
...
| <<ecs-malware_score,Malware Score>> | These fields contain the malware score.

| <<ecs-memory_region,Memory Region>> | These fields contain information about a memory region.

| <<ecs-module_info,Module Info>> | These fields contain information about a module.
...
| <<ecs-parent,Parent>> | These fields contain information about a parent.
...
| <<ecs-stack_frame,Stack Frame>> | TODO
...
| <<ecs-token,Token>> | These fields contain information about a token.

...
This is the documentation of ECS version 1.4.0-dev.
...
| <<ecs-lib,Dynamic library>> | These fields contain information about libraries, including both kernel-mode modules, and process modules.

...
| $$$field-client-ip$$$ [client.ip](#field-client-ip) | IP address of the client (IPv4 or IPv6).<br><br>type: ip<br><br> | core |
...
| $$$field-client-nat-ip$$$ [client.nat.ip](#field-client-nat-ip) | Translated IP of source based NAT sessions (e.g. internal client to internet).<br><br>Typically connections traversing load balancers, firewalls, or routers.<br><br>type: ip<br><br> | extended |
| $$$field-client-nat-port$$$ [client.nat.port](#field-client-nat-port) | Translated port of source based NAT sessions (e.g. internal client to internet).<br><br>Typically connections traversing load balancers, firewalls, or routers.<br><br>type: long<br><br> | extended |

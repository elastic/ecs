...
The following table summarizes the alignment status by namespaces between ECS in version `9.4.0` and OpenTelemetry semantic conventions in version `1.38.0`.

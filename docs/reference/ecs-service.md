...
| --- | --- | --- |
| `service.origin.*` | `service` | Describes the origin service in case of an incoming request or event. |
| `service.target.*` | `service` | Describes the target service in case of an outgoing request or event. |

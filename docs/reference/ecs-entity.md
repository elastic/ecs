...
| $$$field-entity-attributes-storage-class$$$ [entity.attributes.storage_class](#field-entity-attributes-storage-class) | _This field is beta and subject to change._ The storage tier or class assigned to an object storage resource (e.g. S3/GCS/Azure object tiers). Common examples include `STANDARD`, `STANDARD_IA`, `GLACIER`, `COLDLINE`. Typically applicable to Service entities.<br><br>type: keyword | extended |

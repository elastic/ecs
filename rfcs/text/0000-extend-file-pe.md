...
| file.pe.debug.size | keyword | Size of the debug information. |
| file.pe.debug.type_str | keyword | Format of the debug information. |
| file.pe.debug.type | keyword | Information type generated by the debug options. |
| file.pe.debug.timestamp | date | Timestamp of the debug information. |
| file.pe.imports | flattened | List of all imported functions |
| file.pe.sections | nested | Data about sections of compiled binary PE |
| file.pe.sections.chi2 | long | Chi-square probability distribution. |
| file.pe.sections.virtual_address | long | Virtual address available to the file. |
| file.pe.sections.entropy | float | Measurement of entropy randomness in the file. |

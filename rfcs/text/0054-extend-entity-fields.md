...
| entity.attributes.known_redirects | keyword (list) | Service | Known redirect URIs or URLs associated with this entity, commonly for OAuth applications or services. |

...
Concerns have been rasised about how these fields relate to the event fields. Specifically, the data stream fields do not relate to event.type, event.category, event.kind etc. 

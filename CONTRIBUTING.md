...
teams to build OTel native constructs in the Elastic stack. In the meantime, our internal and external ECS users need
to be able to develop features for Elastic that rely on continued contributions to the schemas that drive our
technology.
...
- First, merge a pull request to OTel with new fields, namespaces or schemas
- Second, to backport those changes to ECS at the ECS starting point indicated below
